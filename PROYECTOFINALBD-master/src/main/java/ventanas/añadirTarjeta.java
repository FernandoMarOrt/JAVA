...
public class añadirTarjeta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("AÑADIR TARJETA");
    ...
    private void jButton7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton7MouseClicked
        ...
        if (jTextField6.getText().isEmpty()) {
            ...
            Utilidades.CreacionModificacionBorradoEntidades.crearTarjetaD(jTextField6.getText());
            JOptionPane.showMessageDialog(null, "Se ha creado la tarjeta correctamente");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(añadirTarjeta.class
