...
public class modificarHabitacion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 20, 410, 40));
        ...
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 160, 90, -1));
        ...
        getContentPane().add(jTextField7, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 200, 240, 20));
        ...
        getContentPane().add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 200, 90, -1));
        ...
        getContentPane().add(jTextField8, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 240, 240, 20));
        ...
        getContentPane().add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 240, 90, -1));
        ...
        getContentPane().add(jTextField9, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 280, 220, 20));
        ...
        getContentPane().add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 280, 110, -1));
        ...
        getContentPane().add(jTextField10, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 320, 240, 20));
        ...
        getContentPane().add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 320, 90, -1));
    ...
    private void jButton7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton7MouseClicked
        ...
        Habitacion habitacion = hc.findHabitacion(idBuscada);

        if (listaHabitacion.contains(habitacion)) { //Si la lista con tiene la factura con la pk proporcionada
            ...
            if (listaHabitacion.stream().anyMatch(h -> h.getNumeroHabitacion() == nHabitacion)) {
                ...
                try {
                    Utilidades.CreacionModificacionBorradoEntidades.modificarHabitacion(habitacion, nHabitacion, nCamas, piso, aireA, calefaccion);
                } catch (Exception ex) {
                    Logger.getLogger(modificarHabitacion.class.getName()).log(Level.SEVERE, null, ex);
                }

                JOptionPane.showMessageDialog(null, "Se ha modificado correctamente la habitacion");

            }

        } else { //Si no salta un error avisandole que no esta en la base de datos

            JOptionPane.showMessageDialog(null, "El codigo introducido no corresponde a una habitacion de la base de datos");
