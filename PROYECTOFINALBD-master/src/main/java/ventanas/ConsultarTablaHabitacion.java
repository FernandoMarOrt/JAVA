 ...
 * @author fer
 */
public class ConsultarTablaHabitacion extends javax.swing.JFrame {

    /**
     * Creates new form consultarFactura
     */
    public ConsultarTablaHabitacion() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Consultar Habitacion");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 20, 390, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarTablaHabitacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarTablaHabitacion().setVisible(true);
            }
        });
    }
