...
public class Cinta {
    ...
    //METODOS PARA DEVOLVER UNA LISTA CON LOS PRODUCTOS DE CADA TIPO DE IVA
     public int listaIVA4() {
        
        ArrayList<Productos> listaIVA4 = new ArrayList();
    ...
    public int listaIVA10() {
        
        ArrayList<Productos> listaIVA10 = new ArrayList();
    ...
    public int listaIVA21() {

        ArrayList<Productos> listaIVA21 = new ArrayList();
