 ...
 * @author fer
 */
public class ConsultarTablaReserva extends javax.swing.JFrame {

    /**
     * Creates new form consultarFactura
     */
    public ConsultarTablaReserva() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Consultar Reserva");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarTablaReserva.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarTablaReserva().setVisible(true);
            }
        });
    }
