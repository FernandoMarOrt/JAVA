...
public class EliminarReserva extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 30, 330, 40));
        ...
        jLabel11.setText("Codigo Reserva");
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        List<Reserva> listaReserva = rc.findReservaEntities(); //Relleno la lista con las facturas de la base de datos

        int idBuscada = Integer.parseInt(jTextField1.getText());

        if (listaReserva.contains(rc.findReserva(idBuscada))) {

         
            
            try {
                rc.destroy(idBuscada); //Borro el cliente
            ...
            JOptionPane.showMessageDialog(null, "El codigo introducido no corresponde a ninguna reserva en la base de datos");
        }
 ...
 private void MostrarTabla() {
        ...
        String titulos[] = {"ID", "ID Cliente" , "ID Habitacion" , "Fecha Entrada" , "Fecha Fin", "Nº Dias", "Precio"};
        ...
        if (listaReserva != null) {
            ...
            for (Reserva r : listaReserva) {
                ...
                Object[] objeto = {r.getId(), r.getCliente().getId(), r.getHabitacion().getId() , r.getFechaEntradaLocalDate() , r.getFechaFinLocalDate() , r.getNumeroDias() , r.getPrecio()};
