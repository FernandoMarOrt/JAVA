...
public class ConsultaReserva extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Codigo de la reserva a buscar:");
    ...
    private void jButton6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseClicked
        ...
        Reserva r = rc.findReserva(Integer.valueOf(pkBuscada));
        ...
        if (listaReserva.contains(r)) {
            ...
            JOptionPane.showMessageDialog(null, "El codigo introducido no corresponde a una reserva en la base de datos");
