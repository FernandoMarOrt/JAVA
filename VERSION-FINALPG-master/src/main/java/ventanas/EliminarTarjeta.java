...
public class EliminarTarjeta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ELIMINAR TARJETA");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 30, 350, 40));
        ...
        jLabel11.setText("Codigo Tarjeta");
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 270, 370, 290));
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        List<TarjetaDescuento> listaTarjetas = tc.findTarjetaDescuentoEntities(); //Relleno la lista con las facturas de la base de datos

        int idBuscada = Integer.parseInt(jTextField1.getText());

        if (listaTarjetas.contains(tc.findByIDTarjetaDescuento(idBuscada))) {
            
            try {
                tc.destroy(idBuscada);
            } catch (NonexistentEntityException ex) {
                Logger.getLogger(EliminarTarjeta.class.getName()).log(Level.SEVERE, null, ex);
            }

            JOptionPane.showMessageDialog(null, "Tarjeta eliminada correctamente");

        } else { //Si no salta un mensaje de error
            JOptionPane.showMessageDialog(null, "El codigo introducido no corresponde a ninguna tarjeta en la base de datos");
        }
  ...
  private void MostrarTabla() {
        ...
        String titulos[] = {"ID", "FechaCaducidad"};
        ...
        if (listaTarjetas != null) {
            ...
            for (TarjetaDescuento t : listaTarjetas) {
                //Array con los valores que van a ir en la tabla
                Object[] objeto = {t.getId(), t.getFechaCaducidadLocalDate()};
