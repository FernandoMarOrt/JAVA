...
public class gestionCopiasSeguridad extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 20, 340, 50));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 380, -1, -1));
    ...
    public void restaurarTarjeta(String ruta, String separador) {
        ...
        try ( Scanner datosFichero = new Scanner(new File(ruta), "UTF-8")) {
            ...
            while (datosFichero.hasNextLine()) {
                ...
                Date fechaD = Utilidades.CRUD.localToDate(fecha);
    ...
    public void restaurarReserva(String ruta, String separador) {
        ...
        try ( Scanner datosFichero = new Scanner(new File(ruta), "UTF-8")) {
            ...
            while (datosFichero.hasNextLine()) {
                ...
                Date fechaE = Utilidades.CRUD.localToDate(fechaEL);
                r.setFechaEntrada(fechaE);

                LocalDate fechaFL = LocalDate.parse(tokens[4]);
                Date fechaF = Utilidades.CRUD.localToDate(fechaFL);
