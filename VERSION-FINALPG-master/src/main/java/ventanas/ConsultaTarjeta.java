...
public class ConsultaTarjeta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Codigo de la tarjeta a buscar:");
    ...
    private void jButton6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseClicked
        ...
        TarjetaDescuento t = tc.findTarjetaDescuento(Integer.valueOf(pkBuscada));

        if (listaTarjeta.contains(t)) { 
            
            MostrarTabla();

        } else { //Si no se avisa de que el codigo introducido no corresponde a ninguna factura de la base de datos

            JOptionPane.showMessageDialog(null, "El codigo introducido no corresponde a una tarjeta en la base de datos");
