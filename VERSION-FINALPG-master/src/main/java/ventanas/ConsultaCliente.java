...
public class ConsultaCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Codigo del cliente a buscar:");
    ...
    private void jButton6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseClicked
        ...
        Cliente c = cc.findCliente(Integer.valueOf(pkBuscada));

        if (listaCliente.contains(c)) { //Si la factura con la clave primaria proporcionada esta en la lista
            ...
            JOptionPane.showMessageDialog(null, "El codigo introducido no corresponde a un cliente en la base de datos");
    ...
    private void MostrarTabla() { //Metodo para rellenar la tabla y mostrarla
        ...
        Object[] objeto = {c.getId(), c.getNombre(), c.getApellidos(), c.getDni(), c.getIdtarjetaD().getId(), c.getActivo()};
