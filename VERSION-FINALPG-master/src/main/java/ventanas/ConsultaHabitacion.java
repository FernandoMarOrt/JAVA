...
public class ConsultaHabitacion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Codigo de la habitacion a buscar:");
    ...
    private void jButton6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseClicked
        ...
        Habitacion h = hc.findHabitacion(Integer.valueOf(pkBuscada));

        if (listaHabitacion.contains(h)) { 
            
            MostrarTabla();

        } else { //Si no se avisa de que el codigo introducido no corresponde a ninguna factura de la base de datos

            JOptionPane.showMessageDialog(null, "El codigo introducido no corresponde a una habitacion en la base de datos");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaHabitacion().setVisible(true);
            }
        });
    }
