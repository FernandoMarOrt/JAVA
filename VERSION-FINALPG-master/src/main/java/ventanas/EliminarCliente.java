...
public class EliminarCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 30, 340, 40));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 250, 370, 290));
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        if (listaCliente.contains(cc.findCliente(idBuscada))) {

            try {

                List<Reserva> reservas = cc.findCliente(idBuscada).getReservaList();
                for (Reserva reserva : reservas) {
                    reserva.setCliente(null); // Establecer el campo idCliente en null
                    rc.destroy(reserva.getId()); // Eliminar la reserva
                }

                cc.destroy(idBuscada); //Borro el cliente

            } catch (IllegalOrphanException ex) {

                Logger.getLogger(EliminarCliente.class
            ...
            JOptionPane.showMessageDialog(null, "El codigo introducido no corresponde a ningun cliente en la base de datos");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarCliente.class
