 ...
 * @author fer
 */
public class ConsultarTablaTarjetas extends javax.swing.JFrame {

    /**
     * Creates new form consultarFactura
     */
    public ConsultarTablaTarjetas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Consultar Tarjetas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarTablaTarjetas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarTablaTarjetas().setVisible(true);
            }
        });
    }
